...
<body>
	...
	<div>
		<form:form action = "/shoppingCart/billing" method="post" modelAttribute = "billing">
	<div>
	...
	<div>
		<form:label path="card">Category:</form:label>
		<form:errors path="card" class="text-danger" />
